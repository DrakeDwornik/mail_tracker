...
class Mailpiece(models.Model):
    ...
    address_extra = models.CharField(max_length=150)
    city = models.CharField(max_length=150)
    state = models.CharField(max_length=2)
    zip = models.CharField(max_length=9)
    record_number = models.IntegerField()
    oel = models.CharField(max_length=50)
    imb_numeric = models.CharField(max_length=50)
    imb_alpha = models.CharField(max_length=75)
